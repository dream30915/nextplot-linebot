...
class Container_909a9876ac extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_909a9876ac $container)
			{
	...
	public function createServiceContainer(): Container_909a9876ac
	{
		return $this;
	}
