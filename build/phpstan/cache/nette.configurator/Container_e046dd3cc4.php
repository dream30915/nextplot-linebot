...
class Container_e046dd3cc4 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e046dd3cc4 $container)
			{
	...
	public function createServiceContainer(): Container_e046dd3cc4
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => 'C:\Users\msi\Desktop\nextplot-linebot\phpstan-baseline.neon',
			'usedLevel' => '7',
